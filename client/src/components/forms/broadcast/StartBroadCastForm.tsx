...
import { StartBroadCast } from '../../../services/BroadCastServices';
...
function StartBroadCastForm({ broadcast, users, client }: { broadcast: IBroadcast, users: IUser[], client?: string }) {
  ...
  const formik = useFormik<TformData>({
    initialValues: {
      ...
      is_random_template: Boolean(broadcast.is_random_template),
    ...
    <form onSubmit={formik.handleSubmit}>
      <Stack sx={{ direction: { xs: 'column', md: 'row' } }}>
        ...
        >
          ...
          {
            isSuccess ? (
              <AlertBar message="new template broadcast started" color="success" />
            ) : null
          }
...
export default StartBroadCastForm
