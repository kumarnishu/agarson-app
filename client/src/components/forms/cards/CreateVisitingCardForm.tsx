...
import { CreateVisitingCard } from '../../../services/LeadsServices';
...
function CreateVisitingCardForm({ users }: { users: IUser[] }) {
    const { mutate, isLoading, isSuccess, isError, error } = useMutation
        <AxiosResponse<IVisitingCard>, BackendError, FormData>
        (CreateVisitingCard, {
            onSuccess: () => {
        ...
        <form onSubmit={formik.handleSubmit}>
            ...
            >
                ...
                <Button variant="contained" color="primary" type="submit"
                    disabled={isLoading}
                    fullWidth>{Boolean(isLoading) ? <CircularProgress /> : "Create Vsiting Card"}
                </Button>
            ...
            {
                isSuccess ? (
                    <AlertBar message="new card created" color="success" />
                ) : null
            }
...
export default CreateVisitingCardForm
