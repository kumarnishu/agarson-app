...
import { ToogleHideAllTodos } from '../../../services/TodoServices';
import { ChoiceContext, TodoChoiceActions } from '../../../contexts/dialogContext';


function ToogleHideAllTodosDialog({ ids }: { ids: string[] }) {
        ...
        >
            ...
            <DialogContent>
                <Typography variant="body1" color="error">
                    Warning ! This will Toogle Hide all todos for all connected users
                </Typography>
            </DialogContent>
            <Stack
                direction="column"
...
export default ToogleHideAllTodosDialog
