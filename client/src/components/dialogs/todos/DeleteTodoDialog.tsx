...
function DeleteTodoDialog({ todo }: { todo: ITodo }) {
    ...
    return (
        <>
            <Dialog fullWidth open={choice === TodoChoiceActions.delete_todo ? true : false}
            ...
            >
                ...
                <DialogContent>
                    <Typography variant="body1" color="error">
                        {`Warning ! This will delete todo  ${todo.work_title}`}
