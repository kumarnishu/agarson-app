...
function ProductionDashboard() {
  ...
  useEffect(() => {
    ...
    user?.assigned_permissions.includes('shoe_weight_report_view') && tmpfeatures.push({ feature: 'Shoe Weight Difference report', is_visible: true, url: paths.shoe_weightdiffreport })
    user?.assigned_permissions.includes('dye_status_report_view') && tmpfeatures.push({ feature: 'Dye Status report', is_visible: true, url: paths.dye_statusrepot })
