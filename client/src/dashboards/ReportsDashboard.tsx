...
function ReportsDashboard() {
  ...
  useEffect(() => {
    ...
    tmpfeatures.push({ feature: 'tour reports', is_visible: true, url: paths.tour_reports })
    tmpfeatures.push({ feature: 'crm reports', is_visible: true, url: paths.leads_report })
