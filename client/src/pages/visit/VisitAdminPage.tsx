            ...
            return data.push(
                {
                    ...
                    start_day: new Date(visit.visit.start_day_credientials.timestamp).toLocaleTimeString(),
                    start_day_location: visit.visit.start_day_credientials.address,
                    start_day_coordinates: visit.visit.start_day_credientials.latitude + "," + visit.visit.start_day_credientials.longitude,
                    start_day_photo: visit.visit.start_day_photo?.public_url || "",
                    end_day: new Date(visit.visit.end_day_credentials.timestamp).toLocaleTimeString(),
                    end_day_location: visit.visit.end_day_credentials.address,
                    end_day_coordinates: visit.visit.end_day_credentials.latitude + "," + visit.visit.end_day_credentials.longitude,
                    end_day_photo: visit.visit.end_day_photo?.public_url || "",
                    visit_in: new Date(visit.visit_in_credientials.timestamp).toLocaleTimeString(),
                    visit_in_location: visit.visit_in_credientials.address,
                    visit_in_coordinates: visit.visit_in_credientials.latitude + "," + visit.visit_in_credientials.longitude,
                    visit_in_photo: visit.visit_in_photo?.public_url || "",
                    visit_out: new Date(visit.visit_out_credentials.timestamp).toLocaleTimeString(),
                    visit_out_location: visit.visit_out_credentials.address,
                    visit_out_coordinates: visit.visit_out_credentials.latitude + "," + visit.visit_out_credentials.longitude,
