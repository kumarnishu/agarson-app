    ...
    return (
        <>
            <Stack
                ...
                >
                    <Typography component="h2" variant="button" sx={{ textAlign: "center", color: 'whitesmoke', fontWeight: '400', fontSize: 18, pt: 4 }}>Copyright &copy; Agarson Shoes Pvt Ltd </Typography>
                </Stack>
                <Typography variant="button" component="p"  ><a style={{ textAlign: "center", fontWeight: '400', color: 'whitesmoke' }} href="https://github.com/kumarnishu">Developer : Nishu kumar 91-7056943283</a></Typography>
