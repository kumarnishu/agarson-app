...
export default function ClientSaleReportsPageLastyear() {
    ...
    const { data, isLoading } = useQuery<AxiosResponse<{ reports: IClientSaleReport[], page: number, total: number, limit: number }>, BackendError>(["reports_lastyear", paginationData], async () => GetClientSaleReports({ limit: paginationData?.limit, page: paginationData?.page }))
