...
function UpdateTemplateCategoriesPage() {
    ...
    const { data, isSuccess: isFieldsSuccess, refetch } = useQuery<AxiosResponse<ITemplateCategoryField>, BackendError>("catgeories", GetCategories, {
        staleTime: 10000
    })
    ...
    return (
        <>
            ...
            <Stack spacing={2} p={1} direction="column">
                <Typography variant="button" sx={{ fontWeight: 'bold' }}>Templates Categories</Typography>
...
export default UpdateTemplateCategoriesPage