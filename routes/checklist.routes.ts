...
import { BulkCheckListCreateFromExcel, CreateChecklist, CreateChecklistCategory, DeleteChecklist, DeleteChecklistCategory, EditChecklist, GetAllChecklistCategory, GetChecklists, ToogleChecklist, UpdateChecklistCategory } from "../controllers/checklist.controller";
...
router.route("/checklists/createorupdate").put(isAuthenticatedUser, upload.single('file'), BulkCheckListCreateFromExcel)
