...
router.route("/roles").get(isAuthenticatedUser, GetRoles).post(isAuthenticatedUser, CreateRole).patch(isAuthenticatedUser, AssignRolesToUsers)
router.route("/roles/:id").put(isAuthenticatedUser, UpdateRole)
